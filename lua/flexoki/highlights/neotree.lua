...
M.groups = function()
	...
	return {
		...
		['NeoTreeDimText']      = { fg = c['tx_2'], bg = 'NONE' },
		...
		['NeoTreeFileNameOpened'] = { fg = c['cy_2'], bg = 'NONE' },

		['NeoTreeFilterTerm'] = { fg = c['cy'], bg = 'NONE' },

		['NeoTreeFloatBorder'] = { link = 'FloatBorder' },
		['NeoTreeFloatTitle']  = { fg   = c['tx'], bg = c['bg_2'] },
		...
		['NeoTreeGitIgnored']   = { fg = c['tx_3'], bg = 'NONE' },
		['NeoTreeGitModified']  = { fg = c['ora_2'], bg = 'NONE' },
		['NeoTreeGitUnstaged']  = { fg = c['ora'],   bg = 'NONE' },
		['NeoTreeGitUntracked'] = { fg = c['ye'],   bg = 'NONE' },
		['NeoTreeGitStaged']    = { fg = c['gr_2'], bg = 'NONE' },
